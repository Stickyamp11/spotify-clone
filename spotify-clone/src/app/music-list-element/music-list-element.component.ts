...
@Component({
  ...
  standalone: true,
  imports: [ResponsiveNoneBreak1Directive,ResponsiveNoneBreak1Directive750, CommonModule],
...
export class MusicListElementComponent implements OnInit{
  musicImgs: string[] = ["https://i.scdn.co/image/ab67616d000011ebf2930cf472e6e830b8119740",
    "https://i.scdn.co/image/ab6761610000101f1210c9015e269fd1160e73bc",
  ...
  ngOnInit(){
    this.randomSelected = getRandomInt(this.musicImgs.length)
 }

 isSquare(): boolean{
    return (this.randomSelected < 3)
  }
}
